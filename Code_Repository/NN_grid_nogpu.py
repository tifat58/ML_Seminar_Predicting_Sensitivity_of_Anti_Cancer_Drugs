...
with tf.device('/device:GPU:' + str(gpu)):
    ...
    summ = list()
    stats = []
    summfile = "../reports/summary_" + sys.argv[2] + "_" + sys.argv[1] + "_layerslog5_ep250_ba30_exp.txt"
    ...
    for n_layers in range(int(sys.argv[4]), int(sys.argv[5]) + 1):
        ...
        dir_path = "../Figure/" + "drug_" + str(sys.argv[2]) + "_features_" + str(sys.argv[1]) + "_epoch_" + str(
            training_epochs) + "_nLayerslog_" + str(n_layers) + "_" + str(sys.argv[6])
        ...
        outputfile = "../reports/report_" + sys.argv[2] + "_" + sys.argv[1] + "_layerslog5_ep250_ba30_" + str(
            n_layers) + "_exp.txt"
