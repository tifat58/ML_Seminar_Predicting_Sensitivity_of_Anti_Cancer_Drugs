...
# Block to read variables from text file
...
training_epochs = lines[3].split('=')[1]
batch_size = lines[4].split('=')[1]
display_step = lines[5].split('=')[1]
...
# batch_size = 16
# display_step = 100
# parameters are read from text file
...
#gridsearch
for n_hidden_1 in [110]:
    for n_hidden_2 in [80]:
        outlist = list()
