        ...
        for k_train, k_test in kf.split(data_kv):
            ...
            with tf.Session(
                ...
                for epoch in range(training_epochs):
                    ...
                    epoch_test_accuracy = accuracy.eval({x: new_test_x, y: new_test_y, drop_prob:drop_val})
                ...
                print("Test Accuracy:", accuracy.eval({x: new_test_x, y: new_test_y, drop_prob:1.0}))
                test_accuracy = accuracy.eval({x: new_test_x, y: new_test_y, drop_prob:1.0})
                accuracy_test.update({k_count: test_accuracy})
                outlist.append('Test Accuracy: ' + str(accuracy.eval({x: new_test_x, y: new_test_y, drop_prob:1.0})))
                k_count += 1

                summ.append('Test Accuracy: ' + str(accuracy.eval({x: new_test_x, y: new_test_y, drop_prob:1.0})))

                testaccs.append(accuracy.eval({x: new_test_x, y: new_test_y, drop_prob:1.0}))
