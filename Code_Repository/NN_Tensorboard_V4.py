...
for n_hidden_1 in [50]:
    for n_hidden_2 in [50]:
        ...
        outputfile = "report_" + sys.argv[2] + "_" + sys.argv[1] + "_h1_" + str(n_hidden_1) + "_h2_" + str(
            n_hidden_2) + "_exp.txt"
        ...
        figure_folder = "../Figure/Figure_" + sys.argv[2] + "_" + sys.argv[1] + "_h1_" + str(n_hidden_1) + "_h2_" + str(
            n_hidden_2)
